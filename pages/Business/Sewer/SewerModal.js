    ...
    return (
        <>
            <StyledTable>
                <tbody>
                    <TR>
                        <RSTD $size={returnValue}>
                            제주 상하수도본부 판포하수처리 재이용 시스템</RSTD>
                        <RSTD>
                            <DescriptionStyle>
                                용량
                            </DescriptionStyle>
                    ...
                    <TR>
                        <TD $size={returnValue}>울산 폐수처리 재이용 시스템</TD>
                        <TD>
                            <DescriptionStyle>
                                용량
                            </DescriptionStyle>
                    ...
                    <TR>
                        <TD $size={returnValue}>대구 폐수처리 재이용 시스템</TD>
                        <TD>
                            <DescriptionStyle>
                                용량
                            </DescriptionStyle>
                    ...
                    <TR>
                        <TD $size={returnValue}>제주 폐수처리 재이용시스템</TD>
                        <TD>
                            <DescriptionStyle>
                                용량
                            </DescriptionStyle>
